...
function KioskContent() {
  ...
  return (
    <div className="h-screen w-screen bg-[#0b111e] text-slate-100 flex flex-col overflow-hidden relative select-none">
      {/* On-screen Kiosk Interactive Shell */}
      <div className="no-print h-full w-full flex flex-col overflow-hidden max-w-[1920px] mx-auto">
        ...
        <main className="flex-1 overflow-hidden flex flex-col animate-fade-in relative bg-[#0b111e]">
          {renderCurrentStep()}
        </main>
        ...
        {currentStep > 0 && (
          <footer className="h-8 px-4 sm:px-6 bg-[#0e1422] shadow-[0_-2px_8px_#060a12] border-t border-slate-800/80 flex items-center justify-between text-[11px] text-slate-400 shrink-0 font-medium">
            <div className="flex items-center gap-2 sm:gap-3 truncate">
              <span className="font-bold text-slate-300">Universidad de Dagupan</span>
              <span>•</span>
              <span className="hidden sm:inline">School of Engineering</span>
